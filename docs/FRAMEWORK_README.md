...
**AI coding framework with persistent memory & autonomous agents**

*Stop re-explaining your codebase every session.*

🧠 Memory · 📋 Spec Kit · 🤖 12 Agents · 🛠 21 Skills · ⚡ 60 MCP Tools

<sub>Built for Claude Code · OpenCode · Codex CLI · Gemini CLI · Copilot</sub>
